...
for (var charactersObject in starWarsCharacters) {
  let charactersName = starWarsCharacters[charactersObject].name;
...
let leia = {name: 'Leia Organa', hair_color: "brown", eye_color: "brown"}
...
/* ESERCIZIO 5
  ...
  */
  ...
  for (var charactersObject in starWarsCharacters) {
    ...
    let charactersEyeColor = starWarsCharacters[charactersObject].eye_color;

    switch(charactersEyeColor){
      case 1:
      eyeColor.push(charactersEyeColor);
      break
